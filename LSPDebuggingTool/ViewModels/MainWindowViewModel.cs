...
//         {
//             SettingsStorage.Log.Information("正在保存附属信息");
//             try
//             {
...
//             catch (Exception e)
//             {
//                 SettingsStorage.Log.Error(e.Message, "保存失败");
//             }
//
//             SettingsStorage.Log.Information("保存成功");
//         }
//
//         public static MainWindowViewModel Init()
//         {
//             SettingsStorage.Log.Information("正在初始化视图模型MainWindowViewModel");
//             MainWindowViewModel mainWindowViewModel = new();
//             SettingsStorage.Log.Information("检查上一次使用的附属信息文件路径是否可用");
//             // if (File.Exists(SettingStorage.Instance.LastUsedAncillaryInfoFilePath))
//             //     try
//             //     {
//             //         SettingsStorage.Log.Information("正在读取上一次使用的附属信息文件");
...
//             //         SettingsStorage.Log.Information("读取完成");
//             //     }
//             //     catch (Exception e)
//             //     {
//             //         SettingsStorage.Log.Error(e, "读取失败，置空上一次使用的附属信息文件路径记录。继续初始化");
//             //         SettingStorage.Instance.LastUsedAncillaryInfoFilePath = null;
//             //     }
//
//             SettingsStorage.Log.Information("初始化完成");
...
//             catch (Exception e)
//             {
//                 SettingsStorage.Log.Error(e, "不正常的等待");
//             }
//
//             if (string.IsNullOrEmpty(path.Result)) return;
//             SettingsStorage.Log.Information("正在创建新的附属信息文件");
...
//             catch (Exception e)
//             {
//                 SettingsStorage.Log.Error(e, "实例已更新，但存入序列化或存入文件时失败。");
//             }
//
//             SettingsStorage.Log.Information("创建完成");
//         }
//
//         [ReactiveCommand]
...
//                 {
//                     SettingsStorage.Log.Information("正在加载新的信息文件");
//                     await using var fileStream = File.OpenRead(path.Result);
//                     LSPClientViewModel =
//                         JsonSerializer.Deserialize(fileStream, LSPClientViewModelJSC.Default.LSPClientViewModel);
//                     // SettingStorage.Instance.LastUsedAncillaryInfoFilePath = path.Result;
//                     AncillaryInfoFilePath = path.Result;
//                     SettingsStorage.Log.Information("加载完成");
//                 }
//             }
//             catch (Exception e)
//             {
//                 SettingsStorage.Log.Error(e, "加载失败，实例未更新");
//             }
//         }
